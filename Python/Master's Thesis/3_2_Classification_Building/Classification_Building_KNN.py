# -*- coding: utf-8 -*-
"""FP_Classification_Building_KNN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eJ5AgOk4YoK1aNcQhjexYcYRqwmtiTk2
"""
...
X_train_smoteenn.shape,y_train_smoteenn.shape,X_test.shape,y_test.shape

sns.distplot(y_train_smoteenn[['BUILDINGID']],kde=False)

#tomelinks
from imblearn.under_sampling import TomekLinks
X_train_tomelink, y_train_tomelink = TomekLinks().fit_resample(X_train, y_train)

X_train_tomelink.shape,y_train_tomelink.shape,X_test.shape,y_test.shape

sns.distplot(y_train_tomelink[['BUILDINGID']],kde=False)

#tomelinks
from imblearn.under_sampling import EditedNearestNeighbours
X_train_enn, y_train_enn = EditedNearestNeighbours().fit_resample(X_train, y_train)

X_train_enn.shape,y_train_enn.shape,X_test.shape,y_test.shape

sns.distplot(y_train_enn[['BUILDINGID']],kde=False)
